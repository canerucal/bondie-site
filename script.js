...
const translations = {
  en: {
    ...
    "privacy.formText":
      "The support form is provided by Tally. Tally may process form submissions, apply security checks to reduce abuse, and forward your message to Bondie support. Bondie does not use this information for advertising or tracking.",
  ...
  tr: {
    ...
    "privacy.formText":
      "Destek formu Tally tarafından sağlanır. Tally form gönderimini işleyebilir, kötüye kullanımı azaltmak için güvenlik kontrolleri uygulayabilir ve mesajınızı Bondie destek adresine iletebilir. Bondie bu bilgileri reklam veya izleme amacıyla kullanmaz.",
  ...
  es: {
    ...
    "privacy.formText":
      "El formulario de soporte lo proporciona Tally. Tally puede procesar los envíos, aplicar controles de seguridad para reducir abusos y reenviar tu mensaje al soporte de Bondie. Bondie no usa esta información para publicidad ni seguimiento.",
